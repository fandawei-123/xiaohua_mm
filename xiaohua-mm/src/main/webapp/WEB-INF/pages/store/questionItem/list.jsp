...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/store/questionItem?operation=saveOrUpdate" method="post" enctype="multipart/form-data" >
                ...
                <%--    <div class="col-md-2 title">是否正确答案</div>
                    ...
                    <c:if test="${questionItem.id.length() > 0}">
                        <div class="col-md-2 title">图片</div>
                        <c:if test="${questionItem.picture.length() > 0}">
                            <div class="col-md-10 data " style="block-size: auto;float: right">
                                <img src="${ctx}/upload/${questionItem.picture}"/>
                            </div>
                        </c:if>
                    </c:if>
        ...
        <div class="box-tools text-center">
            ...
            <button type="button" class="btn bg-default" onclick='location.href="${ctx}/store/question?operation=list"'>返回</button>
        </div>
        <!--工具栏/-->
