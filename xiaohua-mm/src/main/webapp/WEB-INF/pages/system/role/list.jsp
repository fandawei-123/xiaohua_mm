                ...
                <div class="table-box">
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <tr>
                            ...
                            <c:if test="${sessionScope.authorStr.contains('system/role?operation=toEdit')}">
                                ...
                                <th class="text-center">
                                    <c:if test="${sessionScope.authorStr.contains('system/role?operation=toEdit')}">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick='location.href="${ctx}/system/role?operation=toEdit&id=${o.id}"'>
                                            编辑
                                        </button>
                                    </c:if>
                                    <c:if test="${sessionScope.authorStr.contains('system/role?operation=author')}">
                                    <button type="button" class="btn bg-olive btn-xs"
