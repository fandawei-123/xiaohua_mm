...
<div class="login-box">
    <div class="login-logo">
        <a href="${pageContext.request.contextPath}/login.jsp">小花面面后台管理系统</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="${pageContext.request.contextPath}/system/user?operation=login" method="post">
            <div class="form-group has-feedback">
                <input type="email" name="email" class="form-control" placeholder="Email" value="xiaohua@huahua.cn">
